...
5. **Save Feature PRD:** Save the generated document as `[###]_FPRD|[feature-name].md` inside the `0xcc/prds/` directory.
...
15. **Decisions from Clarifying Questions:**
    - Record each clarifying question asked, the answer chosen, and its implications
    - This preserves the reasoning for later sessions and for the downstream TDD, TID, and task generation steps
...
* **Format:** Markdown (`.md`)
* **Location:** `0xcc/prds/`
* **Filename:** `[###]_FPRD|[feature-name].md`
...
5. Record the clarifying questions and their answers in the "Decisions from Clarifying Questions" section — the reasoning must survive into future sessions
6. Ensure the PRD provides clear requirements for the subsequent TDD/TID/Tasks workflow
